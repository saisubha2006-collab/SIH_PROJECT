  ...
  return (
    <div className="space-y-4 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 flex items-center justify-between">
          <div className="flex items-center gap-2 text-xs">
            <span className="text-slate-500 dark:text-slate-400 font-medium">Largest Observed Transition:</span>
        ...
        <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 flex items-center justify-between text-xs">
          <div className="flex items-center gap-2">
            <ShieldCheck className="w-4 h-4 text-emerald-400" />
            <span className="text-slate-700 dark:text-slate-300 font-semibold">Data Quality: {quality.level} ({quality.score}/100)</span>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white/90 dark:bg-slate-900/90 border border-rose-500/30 rounded-2xl p-4 lg:p-5 relative overflow-hidden group hover:border-rose-500/60 transition-all shadow-lg">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              className="text-slate-500 hover:text-slate-700 dark:text-slate-300 transition-colors p-1"
          ...
          <div className="mt-2 text-xs text-slate-500 dark:text-slate-400 flex items-center justify-between pt-2 border-t border-slate-200/80 dark:border-slate-800/80">
        ...
        <div className="bg-white/90 dark:bg-slate-900/90 border border-emerald-500/30 rounded-2xl p-4 lg:p-5 relative overflow-hidden group hover:border-emerald-500/60 transition-all shadow-lg">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-sm font-semibold text-slate-500 dark:text-slate-400">ha</span>
          </div>
          <div className="mt-2 text-xs text-slate-500 dark:text-slate-400 flex items-center justify-between pt-2 border-t border-slate-200/80 dark:border-slate-800/80">
        ...
        <div className="bg-white/90 dark:bg-slate-900/90 border border-sky-500/30 rounded-2xl p-4 lg:p-5 relative overflow-hidden group hover:border-sky-500/60 transition-all shadow-lg">
        ...
        <div className="bg-white/90 dark:bg-slate-900/90 border border-amber-500/30 rounded-2xl p-4 lg:p-5 relative overflow-hidden group hover:border-amber-500/60 transition-all shadow-lg">
