  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 lg:p-6 shadow-xl mb-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        ...
        <div className="flex items-center gap-2 bg-slate-950 px-3 py-1.5 rounded-xl border border-slate-800 text-[11px] text-slate-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {scenarios.map((sc) => {
          ...
          const borderStyle = isSelected
            ? isRose
              ? 'border-rose-500 ring-1 ring-rose-500/40 bg-slate-900'
              : isEmerald
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mb-4">{sc.tagline}</p>
                ...
                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800/80 mb-4">
                  <div className="flex items-center justify-between text-xs mb-1.5 font-mono">
                    <span className="text-slate-400">Projected Built-up:</span>
                ...
                <div className="space-y-2.5 text-xs">
                  <div>
                    ...
                    <p className="text-slate-300 mt-0.5 leading-relaxed bg-slate-900/60 p-2 rounded-lg border border-slate-800/60">
                      {sc.assumption}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <code className="text-[11px] font-mono text-sky-300 block bg-slate-950 p-2 rounded border border-slate-800 break-all mt-0.5">
                      {sc.calculation}
                    </code>
                  </div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-800/80 text-[11px] space-y-1.5">
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">Confidence:</span>
                  <span className="font-semibold text-slate-200">{sc.confidence_level}</span>
                </div>
